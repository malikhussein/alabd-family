    ...
    <div className="container mx-auto px-4 py-12 md:py-20 ">
      ...
      <div className="mt-12 space-y-6">
        ...
        <p className=" text-lg md:text-xl lg:text-2xl text-white text-right leading-6 whitespace-pre-wrap">
          {`
قبيلة آل العبد هي إحدى قبائل الحباب من قحطان، وهي قبيلة عريقة عُرفت منذ القدم بالكرم والشجاعة ونبل الأخلاق، وتمسكت بالعادات العربية الأصيلة قولًا وفعلًا،

فكان لها حضورها المميز ومكانتها المرموقة بين قبائل قحطان وسائر القبائل.


ينتمي أبناء آل العبد إلى أصل عربي صريح، وقد اشتهروا بحسن الجوار، وإغاثة الملهوف، والوفاء بالعهود، إضافة إلى بأسهم في المواقف الصعبة،

وهو ما جعل اسمهم حاضرًا في ميادين الشرف والذكر الطيب
...
وتنقسم قبيلة آل العبد إلى أربعة فخوذ رئيسية، يجمعها النسب الواحد والولاء المتين، وقد توزعت مساكنهم قديمًا وحديثًا في عدة مواقع،
 ...
 من أبرزها وادي ملاح، ومحافظة الأمواة، وجبال السود، وهجرة قرى، وهي ديار معروفة ارتبط اسم القبيلة بها عبر أجيال متعاقبة.


ومع اتساع رقعة الاستقرار والتنقل، سكن عدد من أبناء القبيلة في صبحاء والمزاحمية والخرج،

كما امتد وجودهم إلى دول الخليج العربي، خاصة قطر والإمارات، حيث كان لهم دور اجتماعي وتاريخي مشرف.
